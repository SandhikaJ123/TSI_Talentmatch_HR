    ...
    for i, c in enumerate(results):
        ...
        conn.execute(
            """INSERT INTO candidates
               (id,session_id,name,file_name,file_size,raw_text,final_score,grade_label,grade_color,
                breakdown,title,location,email,phone,strengths,weaknesses,summary,embedding,embedding_model)
               VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)""",
            (
